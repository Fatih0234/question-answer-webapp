...
<p align="left">
Hey there, In this project I have built a question-answer web app where users can ask questions to experts with python Flask framework empowered a sql database. 
</p>


<h1>Features of the app</h1>
1. You can ask a question to a specific expert
2. As an expert, you can answer a question and that question will appear on the home page and everybody can benefit from that question-answer thread.
3. Finally, as an admin, you can set certain users as an expert.
...
<img src="" alt="calculator" width="300" height="500">
<br>
<img src="" alt="calculator" width="300" height="500">
<br>
<img src="" alt="calculator" width="300" height="500">
